...
jQuery.fn.daterangepicker = function(settings){
	...
	function constrainTheOtherPicker(which) {
		if (which == 'range-start') {
			rp.find('.range-end').datepicker( "option", "minDate", rp.find('.range-start').datepicker('getDate'));
		}
		if (which == 'range-end') {
	...
	//Triggering it once before start
	constrainTheOtherPicker('range-end');
	constrainTheOtherPicker('range-start');
